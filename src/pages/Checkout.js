                            ...
                            <div className="space-y-6 ">
                                ...
                                <div className="border-b border-gray-900/10 pb-12">
                                    ...
                                    <p className="mt-1 text-sm leading-6 text-gray-600">
                                        Choose among the existing address
                                    </p>
                                    <ul role="list" className=" ">
                                        ...
                                        {addresses.map((address) => (
                                            <div className="py-2">
                                                ...
                                                <li key={address.id} className="flex border-solid border-2 border-gray-200 justify-between gap-x-6 px-3 py-5">
                                                    ...
                                                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                                        <p className="text-sm leading-6 text-bold text-gray-900">Phone : {address.phone}</p>
                                                            ...
                                                            <div className="ml-4 flex flex-1 flex-col">
                                                                ...
                                                                <div className="flex flex-1 items-end justify-between text-sm">
                                                                    ...
                                                                    <div className="flex items-end justify-between  text-sm">
                                                                        <div className="inline mr-2 text-gray-500  mb-3">Qty
                                                                        </div>
                                        ...
                                        <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
                                            <p>
                                                ...
                                                <Link to="/">
                                                    <button
                                                        type="button"
                                                        className="font-medium ml-5 text-indigo-600 hover:text-indigo-500"
